/****************************************************************************/
/*                                                                          */
/* Copyright (C) Cambridge Electronic Design Ltd, 1992-2005                 */
/* All Rights Reserved                                                      */
/*                                                                          */
/* Title:      USE1401.H                                                    */
/*                                                                          */
...
/*  04/Sep/02  TDB  Added transfer flag for USB2.                           */
/*  14/Sep/02  GPS  Added U14CloseAll for crash exits                       */
/*  23/Sep/02  TDB  Added U14SetTransferEvent, and transfer flag to         */
/*                  indicate event notification capability.                 */
/*  15/Apr/03  TDB  Added transfer flag to indicate PCI can short cycle.    */
/*  18/Feb/04  TDB  Added U14WorkingSet function.                           */
/*  19/Nov/04  TDB  Added support for forced driver resets.                 */
/*  26/Oct/05  TDB  Added support for the Power1401 mkII.                   */
/*  29/Jan/08  TDB  Added interface to the circular-mode functions,         */
/*                  commented-out declarations of obsolete functions.       */
/*                                                                          */
/****************************************************************************/
...
U14API(short) U14DriverName(LPSTR lpBuf, WORD wMax);
